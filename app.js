...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // === FORM Config ===
const FORMSPREE_FORM_ID = 'mblaaygr'; // <- PODMIEŃ na swój ID z Formspree
const FORMSPREE_ENDPOINT = `https://formspree.io/f/${FORMSPREE_FORM_ID}`;
    ...
    async function submitToNotion(email) {
        const payload = {
          ...
          language: 'pl',
          _replyto: email, // lepszy Reply-To
          _gotcha: document.getElementById('gotcha')?.value || '', // honeypot
        ...
        return { success: false, error: detail || `HTTP ${res.status}`, status: res.status };
      }
